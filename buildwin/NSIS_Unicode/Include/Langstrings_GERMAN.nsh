...
LangString LangDialog_Title ${LANG_GERMAN} "OESENC_PI 0.1.1106 Installation"
...
LangString Uninstall_Link ${LANG_GERMAN} "OESENC_PI 0.1.1106 deinstallieren"
...
LangString Page_TypeInst_Subtitle_1 ${LANG_GERMAN} "Installation von OESENC_PI gefunden."
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_GERMAN} "OESENC_PI 0.1.1106 ist bereits installiert."
...
LangString Label_TypeInst_Downgrade_Text ${LANG_GERMAN} "Eine neuere Version von OESENC_PI ist auf Ihrem System installiert. Es wird nicht empfohlen, eine ältere Version zu installieren."

#LangString RB_Downgrade_TypeInst_Text ${LANG_ENGLISH} "Downgrade OESENC_PI using previous settings (recommended)"
LangString RB_Downgrade_TypeInst_Text ${LANG_GERMAN} "Downgrade von OESENC_PI mit den vorherigen Einstellungen (empfohlen)"
...
LangString ^NameDA ${LANG_GERMAN} "OESENC_PI Version 0.1.1106"
...
LangString Label_TypeInst_Parallel_Text ${LANG_GERMAN} "Setup hat mehrere installierte Versionen von OESENC_PI auf Ihrem System gefunden. On the next screen, you will be asked to choose the desired install location for OESENC_PI Version 0.1.1106."
...
LangString Page_TypeInst_Subtitle ${LANG_GERMAN} "$MULTIPLE_INSTALLS Installationen von OESENC_PI gefunden."
