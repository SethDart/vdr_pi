...
LangString Page_TypeInst_Subtitle_1 ${LANG_CZECH} "Nalezena nainstalovaná verze OESENC_PI."
...
LangString Label_TypeInst_Downgrade_Text ${LANG_CZECH} "Novější verze OESENC_PI je nainstalována na Vašem systému. Není doporučováno downgradovat na starší verzi."

#LangString RB_Downgrade_TypeInst_Text ${LANG_ENGLISH} "Downgrade OESENC_PI using previous settings (recommended)"
LangString RB_Downgrade_TypeInst_Text ${LANG_CZECH} "Downgrade OESENC_PI s původním nastavením (doporučeno)"
...
LangString Page_TypeInst_Subtitle ${LANG_CZECH} "$MULTIPLE_INSTALLS installations of OESENC_PI found."
