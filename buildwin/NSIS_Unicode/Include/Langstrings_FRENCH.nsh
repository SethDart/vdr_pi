...
LangString LangDialog_Title ${LANG_FRENCH} "OESENC_PI 0.1.1106 Installation"
...
LangString Installation_Directory ${LANG_FRENCH} "Dossier d'installation"
...
LangString Uninstall_Link ${LANG_FRENCH} "Désinstalle OESENC_PI 0.1.1106"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_FRENCH} "OESENC_PI 0.1.1106 est déjà installé."
...
LangString RB_Upgrade_TypeInst_Text ${LANG_FRENCH} "Mise à jour OESENC_PI avec les paramètres existants (recommandé)"
...
LangString Label_TypeInst_Downgrade_Text ${LANG_FRENCH} "Une version plus récente d'OESENC_PI est installée. Le retour à une ancienne version n'est pas recommandé."
...
LangString Msg_UAC_No_Elevation ${LANG_FRENCH} "Impossible d'accéder aux privilèges nécessaires, erreur $0"
...
LangString ^NameDA ${LANG_FRENCH} "OESENC_PI Version 0.1.1106"
...
LangString Label_TypeInst_Parallel_Text ${LANG_FRENCH} "Plusieurs versions ont été détectées de OESENC_PI sur votre système.Sur l'écran suivant, vous serez invité à choisir l'emplacement d'installation souhaité pour OESENC_PI Version 0.1.1106."
...
LangString Page_TypeInst_Subtitle ${LANG_FRENCH} "$MULTIPLE_INSTALLS installations d'OESENC_PI détectées."
