...
int vdr_pi::Init(void)
{
      ...
      //    This PlugIn needs two toolbar icons
        ...
        m_tb_item_id_record = InsertPlugInToolSVG(_T( "VDR" ),
            _svg_record, _svg_record_rollover, _svg_record_toggled,
            wxITEM_CHECK, _("Record"), _T( "" ), NULL,
            VDR_TOOL_POSITION, 0, this);
		m_tb_item_id_play = InsertPlugInToolSVG(_T( "VDR" ),
            _svg_play, _svg_play_rollover, _svg_play_toggled,
...
{
      return _("Voyage Data Recorder");
}

wxString vdr_pi::GetLongDescription()
{
      return _("Provides NMEA stream save and replay.");
